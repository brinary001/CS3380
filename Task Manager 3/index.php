<?php
	...
	function generateTaskTableHTML($tasks) {
		...
		$html .= "<table>\n";
		$html .= "<tr><th>id</th><th>add date</th><th>completed date</th><th>title</th><th>description</th><th>category</th></tr>\n";
		...
		foreach ($tasks as $task) {
			...
			$html .= "<tr><td>$id</td><td>$addDate</td><td>$completedDate</td><td>$title</td><td>$description</td><td>$category</td></tr>\n";
		}
		$html .= "</table>\n";
